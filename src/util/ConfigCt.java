...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="9.22";//插件版本号
	public static final String PLUGIN_NAME="playbull.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.example.nn";//插件名字；
